...
export const DEFAULTS: Config = {
  ...
  // Measured on a real session (replayed through replay.ts): 4.49 chars per token. The old 3.3
  // overstated token counts by 36%, so every threshold fired that much earlier than asked.
  charsPerToken: 4.49,
  cacheMode: "off",
  cacheLagSteps: 8,
};
